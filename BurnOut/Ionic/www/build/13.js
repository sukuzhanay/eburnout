...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__adduser__ = __webpack_require__(764);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_database_profile_list_service__ = __webpack_require__(290);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_database_bracelet_list_service__ = __webpack_require__(289);
...
var AdduserPage = (function () {
    ...
    AdduserPage.prototype.addUser = function (user) {
        var _this = this;
        if (this.ctrls_add.valid) {
            ...
            var self = this;
            __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["Observable"].combineLatest(this.braceletListService.getBraceletList().valueChanges())
                .subscribe(function (bracelets) {
                _this.user.bracelet_id = "";
                for (var i = 0; i < bracelets.length; i++) {
                    for (var j = 0; j < bracelets[i].length; j++) {
                        if (bracelets[i][j].code == _this.user.code) {
                            if (bracelets[i][j].key != undefined) {
                                _this.user.bracelet_id = bracelets[i][j].key.toString();
                            }
                        }
                    }
                }
                self.profileListService.addUser(self.user).then(function (ref) {
    ...
    AdduserPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_5__providers_database_bracelet_list_service__["a" /* BraceletListService */]])
    ], AdduserPage);
    return AdduserPage;
}());
